...
export default function Destinations({ staggerContainer, fadeInUp }: any) {
  return (
        <motion.div
          ...
          className="w-full max-w-[1360px] mt-8 scroll-mt-6 md:scroll-mt-8 bg-transparent px-6 py-6 md:px-12 md:py-8 relative overflow-hidden transition-all duration-500 flex flex-col justify-center items-center"
        >
          ...
          <motion.div variants={fadeInUp} className="text-center max-w-4xl mx-auto z-10 flex flex-col items-center mb-10">
            <h2 className="text-4xl sm:text-5xl md:text-[62px] leading-[1.08] tracking-tight text-white mb-4">
          ...
          {/* Trust Badges Row */}
          <motion.div variants={fadeInUp} className="w-full max-w-5xl mx-auto z-10 flex flex-wrap justify-center items-center gap-6 md:gap-14 mb-10 opacity-70">
            <div className="flex items-center gap-2 text-white font-bold tracking-tight text-sm sm:text-base select-none hover:opacity-100 transition-opacity font-sans">
              ⭐ 4.9/5 Rating
            </div>
            <div className="flex items-center gap-2 text-white font-semibold tracking-tight text-xs sm:text-sm select-none hover:opacity-100 transition-opacity font-sans">
              ✓ Verified by TripAdvisor
            </div>
            <div className="flex items-center gap-2 text-white font-semibold tracking-tight text-sm select-none hover:opacity-100 transition-opacity font-sans">
              🏆 Best Tour Operator
            </div>
            <div className="flex items-center gap-1 text-white font-semibold tracking-tight text-sm select-none hover:opacity-100 transition-opacity font-sans">
              24×7 Support Available
            </div>
            <div className="flex items-center gap-2 text-white font-semibold uppercase tracking-widest text-[11px] select-none hover:opacity-100 transition-opacity font-sans">
              ✓ Money-Back Guarantee
            </div>
          </motion.div>

          {/* Thin separator line */}
          <div className="w-full border-t border-white/10 my-4 z-10" />
